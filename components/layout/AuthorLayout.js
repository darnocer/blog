  ...
  return (
    <div className='mx-auto max-w-3xl'>
      ...
      <div className='items-start space-y-2 xl:grid xl:grid-cols-3 xl:gap-x-8 xl:space-y-0'>
        <aside className='mt-6 rounded-md border bg-white p-4 text-center dark:border-gray-700 dark:bg-black xl:sticky xl:top-24 xl:col-start-1 xl:row-span-2 xl:max-h-max'>
          ...
          <div className='mt-4 pt-4 text-left font-serif text-sm text-gray-500 dark:text-gray-300'>{bio}</div>
        </aside>
