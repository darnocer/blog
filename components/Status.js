...
const Status = ({ text }) => {
  return (
    <div
      className="btn hover:pointer mr-6 inline-flex items-center justify-center gap-2 rounded-xl px-4
                 py-1 border border-gray-700
                 dark:border-gray-300/20 bg-gray-800
                 dark:bg-black text-sm font-semibold text-gray-100
                 dark:text-gray-100 
                 transition-all shadow-lg hover:shadow-[0_0_10px_rgba(255,255,255,0.1)] hover:no-underline"
    >
