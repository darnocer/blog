...
<span className="bold-underline">I'm currently open to paid work</span>, where I can support the implementation of meaningful initiatives with an organization whose mission is aligned to [my values](/transformational-wellness).

- Learn more about my **Transformational Wellness** work [here](/transformational-wellness).
...
<Button action="contact" text="Email Me" link="mailto:darian@soul-science.com?Subject=Website Contact" />
